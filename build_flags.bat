...
set FLAGS="-D___SOFTWARE_VERSION___=\"%VERSION%\"" -D___HARDWARE_MAJOR_VERSION___=%1 -D___HARDWARE_MINOR_VERSION___=%2 -DHV_SWITCHING_BOARD_BAUD_RATE=%3 -DHV_SWITCHING_BOARD_I2C_RATE=%4
echo %FLAGS%
